...
pub fn build_router(state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route("/vault_stats", get(handlers::api_vault_stats).post(handlers::api_vault_stats))
        ...
        .route("/v1/vault_stats", get(handlers::api_vault_stats).post(handlers::api_vault_stats))
